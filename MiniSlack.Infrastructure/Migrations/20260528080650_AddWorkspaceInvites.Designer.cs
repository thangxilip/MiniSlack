...
namespace MiniSlack.Infrastructure.Migrations
{
    ...
    [Migration("20260528080650_AddWorkspaceInvites")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiniSlack.Domain.Workspaces.WorkspaceInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AcceptedByUserId")
                        .HasDatabaseName("ix_workspace_invites_accepted_by_user_id");
                    ...
                    b.HasIndex("WorkspaceId", "NormalizedEmail")
                        .HasDatabaseName("ix_workspace_invites_workspace_id_normalized_email");
            ...
            modelBuilder.Entity("MiniSlack.Domain.Workspaces.WorkspaceInvite", b =>
                {
                    b.HasOne("MiniSlack.Domain.Users.User", "AcceptedByUser")
                        .WithMany()
                        .HasForeignKey("AcceptedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_workspace_invites_users_accepted_by_user_id");

                    b.HasOne("MiniSlack.Domain.Users.User", "InvitedByUser")
                        .WithMany()
